...
function _lazyload() {
	...
	if(_container.length > 0) {
		loadScript(plugin_path + 'jquery.lazyload.min.js', function() {
...
function _countDown() {
	...
	if(_container.length > 0 || _container2.length > 0) {
		...
		loadScript(plugin_path + 'jquery.countdown.pack.min.js', function() {
...
function _toastr(_message,_position,_notifyType,_onclick) {
	...
	if(_btn.length > 0 || _message != false) {
		...
		loadScript(plugin_path + 'toastr.js', function() {
			// toastr.clear();
...
function _form() {
	...
	if(_container.length > 0) {
		...
		loadScript(plugin_path + 'jquery.maskedinput.js', function() {
...
function _pickers() {
	...
	if(_container_1.length > 0) {
		loadScript(plugin_path + 'bootstrap-datepicker.min.js', function() {
			...
			if(jQuery().datepicker) {
				...
				_container_1.each(function() {
					...
					if(_lang != 'en' && _lang != '') { // load language file
						loadScript(plugin_path + 'datepicker-locales/bootstrap-datepicker.'+_lang+'.min.js');
					}
	...
	if(_container_2.length > 0) {
		loadScript(plugin_path + 'moment.min.js', function() {
			loadScript(plugin_path + 'daterangepicker.js', function() {
	...
	if(_container_3.length > 0) {
		loadScript(plugin_path + 'timepicki.min.js', function() {
...
function _infiniteScroll() {
	...
	if(_container.length > 0) {
		...
		loadScript(plugin_path + 'jquery.infinitescroll.min.js', function() {
...
function _zoom() {
	...
	if(_container.length > 0) {
		...
		loadScript(plugin_path + 'jquery.zoom.min.js', function() {
